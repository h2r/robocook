		...
		$.playground()
			...
			*/
			...
			.addGroup("recipeBackground", {width: 384, height: 192, posx: 384, posy: 0})
				...
				.addGroup("recipeDiv", {width: 374, height: 192, posx: 394, posy: 0})
					.css({"font-size":"8pt", "color":"black", "overflow":"auto"})
				.end().end()
			.addGroup("consoleBackground", {width: 384, height: 192, posx: 0, posy: 0})
				...
				.addGroup(matchConsole.DisplayDiv, {width: 374, height: 192, posx: 10, posy: 0})
					.css({"font-size":"8pt", "color":"green", "overflow":"auto"})
					.end().end()
